...
export default function ContactSection() {
  return (
    <section className="flex flex-col md:flex-row pt-28 items-center md:items-start px-6 py-12 max-w-6xl mx-auto">
      <Navbar />
      ...
      <div className="md:w-1/2 h-full">
        <img src={assets.contact} alt="Contato" className="w-full h-auto object-cover rounded-lg shadow-md" />
      </div>
    </section>
  );
}
